from .remote_host_patch_metaclass import PatchRemoteHostMeta, PatchTrackedRemoteExecutionMeta
...
class TestAsset():
    ...
    PatchTrackedRemoteExecutionMeta = PatchTrackedRemoteExecutionMeta
